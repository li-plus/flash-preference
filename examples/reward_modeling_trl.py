# Adapted from https://github.com/huggingface/trl/blob/v0.19.0/examples/scripts/reward_modeling.py
...
"""
Full training:
python3 examples/reward_modeling_trl.py \
